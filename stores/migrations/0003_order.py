    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_status', models.CharField(choices=[('completed', 'completed'), ('pending', 'pending'), ('cancelled', 'cancelled')], max_length=255, null=True)),
                ('payment_method', models.CharField(choices=[('paystack', 'paystack'), ('transfer', 'transfer')], default='paystack', max_length=255, null=True)),
